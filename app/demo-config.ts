...
function getSystemPrompt() {
  ...
  ## Tool Usage Rules
  - Always call the "updateOrder" tool immediately when the user confirms, adds, removes, or changes quantity of any item, and also once again at the end to finalize the full order.
